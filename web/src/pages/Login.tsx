...
import logoImg from '../images/acaflix.svg'
import logoImg1 from '../images/meteorite.svg'
  ...
  const handleRegister = async(event: FormEvent) =>{
    ...
    if (data.name == ""){
      ...
      if (teste.data.length > 0){
        console.log("Already Registered", teste);
  ...
  return(
    <div id="login-page">
      <div className="content-container">
        <main>
        <img src={logoImg} alt="sim"/>

          <h1>Here to <span>Destroy</span> your Boredoom</h1>
